...
class Tafri_Travel_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $Tafri_Travel_Icon_Changer_array = Tafri_Travel_Icon_Changer_array();
                    foreach ($Tafri_Travel_Icon_Changer_array as $Tafri_Travel_Icon_Changer) {
                            $icon_class = $this->value() == $Tafri_Travel_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($Tafri_Travel_Icon_Changer).'"></i>
                            <span class="tafri-travel-social-class">'.esc_attr($Tafri_Travel_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function tafri_travel_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'tafri-travel-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'tafri_travel_icon_customize_js' );

if(!function_exists('Tafri_Travel_Icon_Changer_array')){
    function Tafri_Travel_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
