...
class Tafri_Travel_Widget_About_Us extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Tafri_Travel_Widget_About_Us',
			__('Themeseye About us', 'tafri-travel'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'tafri-travel' ), ) 
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
        <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Add Heading:','tafri-travel'); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>">
    	</p>
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Add Author Name:','tafri-travel'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Add Designation:','tafri-travel'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Add Description:','tafri-travel'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Add Button Text:','tafri-travel'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Add Button Url:','tafri-travel'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Add Image Url:','tafri-travel'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function tafri_travel_about_custom_load_widget() {
	register_widget( 'Tafri_Travel_Widget_About_Us' );
}
add_action( 'widgets_init', 'tafri_travel_about_custom_load_widget' );