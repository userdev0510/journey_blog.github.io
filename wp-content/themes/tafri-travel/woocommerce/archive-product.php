...
<?php
 $tafri_travel_shop_page_sidebar = get_theme_mod( 'tafri_travel_shop_page_sidebar',true );
 if ( false == $tafri_travel_shop_page_sidebar ) {
...
<div class="container">
	<main id="main" role="main">
		<div class="row">
			...
			<?php if ( false != $tafri_travel_shop_page_sidebar ) {?>
